...
# git aliases
alias git_status_all='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/git/git_status_all.sh'
alias git_pull_all='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/git/git_pull_all.sh'
alias git_export_repos='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/git/git_export_repos.sh'
alias git_import_repos='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/git/git_import_repos.sh'
alias git_clone='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/git/git_clone.sh'
alias git_user_change='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/git/git_user_change.sh'

# HRII environment
alias update_hrii_environment='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/install_hrii_environment.sh'

# General aliases
alias nt='reset; . ~/.bashrc'
alias change_ros_ws='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/ros/change_ros_ws.sh'
alias crw='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/ros/change_ros_ws.sh'
alias crv='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/ros/change_ros_version.sh'
alias create_catkin_ws='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/create_catkin_ws.sh'
alias modify_bashrc='gedit ~/.bashrc'
alias modify_hrii_params='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/hrii_params_menu.sh'
alias sd='sudo shutdown now'
alias reboot='sudo reboot'
alias kdev='cd && ./.KDevelop.AppImage'
alias hriicd='. $HOME/git/hrii_gitlab/general/hrii_installation_tools/scripts/hriicd.sh'
...
alias plot_data='python3 $HOME/git/hrii_gitlab/general/hrii_utils/scripts/plot_logged_data.py'
...
# Vision PCs
VISION_PC_ALIENWARE_IP=192.168.0.42
VISION_PC_ZOTAC_IP=192.168.0.43
VISION_PC_ROCCO=192.168.0.44
VISION_PC_ORIN_IP=192.168.0.180

alias vision_pc_alienware='ssh -X hrii_lab@$VISION_PC_ALIENWARE_IP'
alias vision_pc_zotac='ssh -X zotac@$VISION_PC_ZOTAC_IP'
alias vision_pc_rocco='ssh -X hrii@$VISION_PC_ROCCO'
alias vision_pc_orin='ssh -X hrii@$VISION_PC_ORIN_IP'

alias vision_pc_alienware_terminator='terminator -p vision_pc_alienware'
alias vision_pc_zotac_terminator='terminator -p vision_pc_zotac'
alias vision_pc_rocco_terminator='terminator -p vision_pc_rocco'
alias vision_pc_orin_terminator='terminator -p vision_pc_orin'

alias vision_pc_alienware_nautilus='nautilus sftp://hrii_lab@$VISION_PC_ALIENWARE_IP/home/hrii_lab'
alias vision_pc_zotac_nautilus='nautilus sftp://zotac@$VISION_PC_ZOTAC_IP/home/zotac'
alias vision_pc_rocco_nautilus='nautilus sftp://hrii@$VISION_PC_ROCCO/home/hrii'
alias vision_pc_orin_nautilus='nautilus sftp://hrii@$VISION_PC_ORIN_IP/home/hrii &'
